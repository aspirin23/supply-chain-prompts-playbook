...
2. **Go deeper on a pattern** — if one of the five patterns feels relevant to a problem you're working on, the [`patterns/`](./patterns/) folder has a full breakdown with industry-specific examples and failure modes.
